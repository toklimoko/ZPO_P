...
public class Main3Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private Button btn_glosniej;
    private Button btn_slysze;
    ...
    private ActivityCallback mActivityCallback = new ActivityCallback() {
        ...
        private void readReceivedData(final String data) {
            ...
            final float freqency = Float.parseFloat(dataSplit[1]);
            final float amplitude = Float.parseFloat(dataSplit[2]);


            switch (event) {
                case "lg":
                    //gdy lekarz wcisnie "start"
                    msgPacjentGotowy();
...
//        buttonStart();
        ...
        btn_glosniej.setClickable(false);
        btn_slysze.setClickable(false);
...
//        btn_rysuj.setVisibility(View.INVISIBLE);
    ...
    public void msgPacjentGotowy() {

        String action = "pg," + 0 + "," + 0; //'pacjent gotowy'
        byte[] bytesS = action.getBytes();
        if (mBluetoothConnection != null) {
            mBluetoothConnection.write(bytesS);
        }
    ...
    public void odtworz(float frequency, float amplitude) {


        btn_glosniej.setClickable(true);
        btn_slysze.setClickable(true);
        toast4.show();

        Play play = new Play(frequency, amplitude, 1); //odtwarzanie
    ...
    public void msgNieSlysze() {

        btn_glosniej = (Button) findViewById(R.id.btn_glosniej);
        btn_glosniej.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {


                String action = "ns," + 0 + "," + 0; //'pacjent nie slyszy'
                byte[] bytesS = action.getBytes();
                if (mBluetoothConnection != null) {
                    mBluetoothConnection.write(bytesS);
                }
    ...
    public void msgSlysze() {

        btn_slysze = (Button) findViewById(R.id.btn_slysze);
        btn_slysze.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String action = "sl" + 0 + "," + 0; //'pacjent nie slyszy'
                byte[] bytesS = action.getBytes();
                if (mBluetoothConnection != null) {
                    mBluetoothConnection.write(bytesS);
                }
...
//    public void buttonStart(final float frequency, final float amplitude){
//
//
//        Play play = new Play(frequency, amplitude, 1); //odtwarzanie
